package com.sw.api.tarea.controllers;

import com.sw.api.workflow.dtos.ValidarSolicitudRequest;

import com.sw.api.workflow.dtos.ComentarioCreateDTO;
import com.sw.api.workflow.dtos.ComentarioResponseDTO;
...
import com.sw.api.workflow.services.ColaboracionService;
import com.sw.api.tarea.services.TareaService;
...
public class TareaController {
    ...
    public ResponseEntity<TareaResponseDTO> validarSolicitud(
            @PathVariable String id,
            @Valid @RequestBody com.sw.api.workflow.dtos.ValidarSolicitudRequest dto,
            Principal principal) {
